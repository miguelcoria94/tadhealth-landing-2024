          ...
          >
            ...
            >
              <div class="mb-4 pb-4 border-b border-gray-700">
                <div class="h4 text-green-600 mb-1">Essential</div>
              ...
              <div class="border border-gray-700 p-3 mt-6">
                <a
                  class="btn-sm text-white bg-green-600 hover:bg-green-700 w-full"
                  href="#0"
                  >Start free trial</a
                >
              </div>
            ...
            >
              ...
              <div class="mb-4 pb-4 border-b border-gray-700">
                <div class="h4 text-green-600 mb-1">Premium</div>
                <div class="inline-flex items-baseline mb-2">
                  <span
                    class="text-2xl md:text-3xl font-medium text-gray-400"
            ...
            >
              <div class="mb-4 pb-4 border-b border-gray-700">
                <div class="h4 text-green-600 mb-1">Advanced</div>
                <div class="inline-flex items-baseline mb-2">
                  <span
                    class="text-2xl md:text-3xl font-medium text-gray-400"

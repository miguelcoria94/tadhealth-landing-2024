      ...
      <div class="py-12 md:py-20 border-t border-gray-800">
        ...
        <div>
          ...
          >
            ...
            >
              <svg
                class="w-4 h-4 fill-current text-green-600 mr-2"
                viewBox="0 0 16 16"
            ...
            >
              <div class="w-full" v-show="tab === '1'">
                <article class="relative max-w-md mx-auto md:max-w-none">
                  ...
                  <div
                    class="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl"
                  >
                    ...
                    <a
                      class="btn-sm text-white bg-green-600 hover:bg-green-700 mt-6"
                      href="#0"
                    >
                      <span class="text-sm">Learn more</span>
                      <svg
                        class="w-3 h-3 fill-current text-green-400 shrink-0 ml-2"
                        viewBox="0 0 12 12"
                        xmlns="http://www.w3.org/2000/svg"
                      >
            ...
            >
              <div class="w-full" v-show="tab === '2'">
                <article class="relative max-w-md mx-auto md:max-w-none">
                  ...
                  <div
                    class="relative bg-gray-800 py-8 md:py-16 px-6 md:pl-16 md:max-w-lg lg:max-w-xl md:ml-auto"
                  >

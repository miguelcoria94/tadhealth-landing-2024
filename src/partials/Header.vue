      ...
      <div class="flex items-center justify-between h-20">
        ...
        <div class="shrink-0 mr-4">
          ...
          <router-link to="/" class="block" aria-label="Cruip">
            <img class="h-10" src="/src/images/tadheart.png" alt="tadhealth-nav-logo">
          </router-link>
        </div>
        ...
        <nav class="hidden md:flex md:grow">
          ...
          <ul class="flex grow justify-end flex-wrap items-center">
            <li>
              <router-link
                to="/signin"
                class="font-medium text-green-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out"
                >Sign in</router-link
              >
            </li>
            <li>
              <router-link
                to="/signup"
                class="btn-sm text-white bg-green-600 hover:bg-green-700 ml-3"
                >Sign up</router-link
              >
            </li>
          </ul>
          ...
          >
            <ul class="bg-gray-800 px-4 py-2">
              ...
              <li>
                <router-link
                  to="/signin"
                  class="flex font-medium w-full text-green-600 hover:text-gray-200 py-2 justify-center"
                  >Sign in</router-link
                >
              </li>
              <li>
                <router-link
                  to="/signup"
                  class="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2 rounded-sm text-white bg-green-600 hover:bg-green-700 transition duration-150 ease-in-out"
                  >Sign up</router-link
                >
              </li>
            </ul>
